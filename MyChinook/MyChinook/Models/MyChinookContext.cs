...
{
    public partial class MyChinookContext : DbContext
    {
        public MyChinookContext()
        {
        }

        public MyChinookContext(DbContextOptions<MyChinookContext> options)
            : base(options)
        {
        }
                ...
                entity.HasMany(d => d.Tracks)
                    ...
                    .UsingEntity<Dictionary<string, object>>(
                        ...
                        j =>
                        {
                            ...
                            j.IndexerProperty<int>("PlaylistId").ValueGeneratedOnAdd();
                        });
            });
