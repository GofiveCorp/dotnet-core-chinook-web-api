...
namespace MyChinookDomain.Supervisor
{
    public interface IChinookSupervisor
    {
        ...
        Task<EmployeeApiModel> AddEmployeeAsync(EmployeeApiModel newEmployeeApiModel,CancellationToken ct = default);
        Task<bool> UpdateEmployeeAsync(EmployeeApiModel employeeApiModel,CancellationToken ct = default);
        Task<bool> DeleteEmployeeAsync(int id, CancellationToken ct = default);
        Task<IEnumerable<EmployeeApiModel>> GetEmployeeDirectReportsAsync(int id,CancellationToken ct = default);
        ...
        Task<IEnumerable<CustomerApiModel>> GetCustomerBySupportRepIdAsync(int id,CancellationToken ct = default);
        Task<CustomerApiModel> AddCustomerAsync(CustomerApiModel newCustomerApiModel,CancellationToken ct = default);
        Task<bool> UpdateCustomerAsync(CustomerApiModel customerApiModel,CancellationToken ct = default);
        ...
        Task<IEnumerable<InvoiceApiModel>> GetInvoiceByCustomerIdAsync(int id,CancellationToken ct = default);
        Task<InvoiceApiModel> AddInvoiceAsync(InvoiceApiModel newInvoiceApiModel,CancellationToken ct = default);
        Task<bool> UpdateInvoiceAsync(InvoiceApiModel invoiceApiModel,CancellationToken ct = default);
        ...
        Task<IEnumerable<InvoiceLineApiModel>> GetInvoiceLineByInvoiceIdAsync(int id,CancellationToken ct = default);
        Task<IEnumerable<InvoiceLineApiModel>> GetInvoiceLineByTrackIdAsync(int id,CancellationToken ct = default);
        Task<InvoiceLineApiModel> AddInvoiceLineAsync(InvoiceLineApiModel newInvoiceLineApiModel,CancellationToken ct = default);
        Task<bool> UpdateInvoiceLineAsync(InvoiceLineApiModel invoiceLineApiModel,CancellationToken ct = default);
        ...
        Task<MediaTypeApiModel> AddMediaTypeAsync(MediaTypeApiModel newMediaTypeApiModel,CancellationToken ct = default);
        Task<bool> UpdateMediaTypeAsync(MediaTypeApiModel mediaTypeApiModel,CancellationToken ct = default);
        ...
        Task<GenreApiModel> AddGenreAsync(GenreApiModel newGenreApiModel,CancellationToken ct = default);
        ...
        Task<ArtistApiModel> AddArtistAsync(ArtistApiModel newArtistApiModel,CancellationToken ct = default);
        Task<bool> UpdateArtistAsync(ArtistApiModel artistApiModel,CancellationToken ct = default);
        ...
        Task<AlbumApiModel> AddAlbumAsync(AlbumApiModel newAlbumApiModel,CancellationToken ct = default);
        ...
        Task<PlaylistApiModel> AddPlaylistAsync(PlaylistApiModel newPlaylistApiModel,CancellationToken ct = default);
        Task<bool> UpdatePlaylistAsync(PlaylistApiModel playlistApiModel,CancellationToken ct = default);
        ...
        Task<IEnumerable<TrackApiModel>>GetTrackByMediaTypeIdAsync(int id, CancellationToken ct = default);
        Task<IEnumerable<TrackApiModel>> GetTrackByPlaylistIdIdAsync(int id,CancellationToken ct = default);
        Task<TrackApiModel> AddTrackAsync(TrackApiModel newTrackApiModel,CancellationToken ct = default);
